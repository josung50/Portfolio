...
public class DesignInfoViewAdapter extends RecyclerView.Adapter<DesignInfoViewAdapter.Holder> {
    private Context context;
    private List<ItemDataDesignInfo> list = new ArrayList<>();

    public DesignInfoViewAdapter(Context context, List<ItemDataDesignInfo> list) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_designinfo_cardview, parent, false);
    ...
    * */
    ...
    public class Holder extends RecyclerView.ViewHolder{
        ...
        public Holder(View view){
            super(view);
            imageView = (ImageView) view.findViewById(R.id.imageView_designinfo_cardview);
        }
    }
