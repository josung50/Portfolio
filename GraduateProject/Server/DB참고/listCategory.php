...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_category");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['category_code']."</span></td><td>".$row['depth']."</td><td>".addslashes($row['category_name'])."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
