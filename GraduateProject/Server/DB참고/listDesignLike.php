...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_design_work_like");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['design_work_seq']."</span></td><td>".$row['member_seq']."</td><td>".$row['register_time']."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
