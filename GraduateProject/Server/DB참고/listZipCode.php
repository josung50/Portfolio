...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_zip_code ORDER BY seq DESC");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['seq']."</span></td><td>".$row['sido']."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
