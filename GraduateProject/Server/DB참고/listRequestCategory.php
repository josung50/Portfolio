...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_request_board_category");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['board_seq']."</span></td><td>".$row['category_code']."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
