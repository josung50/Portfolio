...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_design_work_category");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['design_work_seq']."</span></td><td>".$row['category_code']."</td><td>".addslashes($row['register_time'])."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
