...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_project_member");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['member_seq']."</span></td><td>".$row['project_seq']."</td><td>".$row['register_time']."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
