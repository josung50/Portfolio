...
//전체 게시물 보기
$query_exec = mysqli_query($link, "SELECT * FROM t_member_category");
...
//    $safeContent = $row['contents'];
    echo "var result = '<tr><td><span id=$boardCnt>".$row['member_seq']."</span></td><td>".$row['category_code']."</td><td>".$row['register_time']."</td><td><button id=\"deleteDB\">DELETE</button></td></tr>';\n";
