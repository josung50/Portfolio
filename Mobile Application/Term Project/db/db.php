...
$_FilePath = urldecode($_POST['_FilePath']);
...
mysqli_query($conn,"INSERT INTO list (num, id, lat, lng, FoodPrice, FoodName, FoodComment, Location, BigOption, SmallOption, FilePath) VALUES ('','$_id','$_lat','$_lng','$_FoodPrice','$_FoodName','$_FoodComment','$_Location','$_BigOption','$_SmallOption','$_FilePath')");
